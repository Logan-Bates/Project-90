...
object ValidationMessages {
    ...
    const val identityNameTooLong = "Keep the name within 50 characters."
    const val identityStatementTooLong = "Keep the statement within 160 characters."
    ...
    const val maxFourIdentities = "You already have 4 identities."
    const val deleteIdentityConfirm = "Delete this identity and its logs?"
